...
def DataLoader(name):
    ...
    if name in ['cora', 'citeseer', 'pubmed']:
    ...
    elif name in ['chameleon', 'squirrel']: # crocodile not available if Geom-GCN transformation is activated.
        ...
        dataset = PygNodePropPredDataset(root='./data/', name=name)
        
    elif name in ['penn94', 'genius', 'wiki', 'pokec', 'arxiv-year', 'twitch-gamer', 'snap-patents', 'twitch-de']:
